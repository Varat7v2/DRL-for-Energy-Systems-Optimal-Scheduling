...
from tools import Arguments, get_episode_return, test_one_episode, ReplayBuffer
...
if __name__=='__main__':
    ...
    for seed in args.random_seed_list:
        ...
        act_save_path = f'{args.cwd}/actor_{seed}.pth'
        loss_record_path = f'{args.cwd}/loss_data_{seed}.pkl'
        reward_record_path = f'{args.cwd}/reward_data_{seed}.pkl'
    ...
    # TODO: Now test on the last seed value
    if args.test_network:
        ...
        eval_data.columns = ['time_step', 'price', 'netload', 'action', 'real_action', 'soc', 'battery',
                             'gen1', 'gen2', 'gen3', 'unbalance', 'operation_cost']
