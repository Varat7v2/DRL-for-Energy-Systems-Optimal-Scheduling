...
class ESSEnv(gym.Env):
    ...
    def step(self, action):     # state transition here current_obs-->take_action-->get reward-->get_finish-->next_obs
        ...
        current_obs, _ = self._build_state()
        ...
        if finish:
            ...
            self.current_time = 0
            # self.day+=1
            # if self.day>Constwithwithwithant.MONTHS_LEN[self.month-1]:
            #     self.day=1
            #     self.month+=1
            # if self.month>12:
            #     self.month=1
...
if __name__ == '__main__':
    ...
    for _ in range (2):   # 144
        ...
        next_obs, reward, terminated, truncated, info = env.step(tem_action)
